...
if (db.lists.length === 0) {
  db.lists = [
    { id: 1, name: '日常作息', color: '#FF9500', sort_order: 0, tasks: [
      ...
      { id: 4, title: '💧 喝水+🧍站立', content: '到工位了，先喝几口水，站起来活动一下', priority: 2, due_time: '09:00', repeat_rule: 'Every Day', reminder_time: '09:00', completed: 0, sort_order: 3 },
      { id: 5, title: '💧 喝水+🧍站立', content: '起来接水，喝几口，站起来伸懒腰', priority: 2, due_time: '10:00', repeat_rule: 'Every Day', reminder_time: '10:00', completed: 0, sort_order: 4 },
      { id: 6, title: '💧 喝水+🧍站立', content: '起来接水走动一下，喝几口', priority: 2, due_time: '11:00', repeat_rule: 'Every Day', reminder_time: '11:00', completed: 0, sort_order: 5 },
      { id: 7, title: '🍱 午餐', content: '先吃菜和肉→主食只吃一半。饭后散步10分钟', priority: 2, due_time: '12:00', repeat_rule: 'Every Day', reminder_time: '12:00', completed: 0, sort_order: 6 },
      { id: 8, title: '😴 午休闭眼10分钟', content: '手机扣桌上闭眼休息', priority: 1, due_time: '13:00', repeat_rule: 'Every Day', reminder_time: '13:00', completed: 0, sort_order: 7 },
      { id: 9, title: '💧 喝水+🧍站立', content: '下午开工，喝几口水，站起来活动一下', priority: 2, due_time: '14:00', repeat_rule: 'Every Day', reminder_time: '14:00', completed: 0, sort_order: 8 },
      { id: 10, title: '🥜 加餐', content: '苹果/一把坚果/一杯酸奶，顺便喝水', priority: 1, due_time: '15:00', repeat_rule: 'Every Day', reminder_time: '15:00', completed: 0, sort_order: 9 },
      { id: 11, title: '💧 喝水+🧍站立', content: '喝几口水，站起来活动一下', priority: 2, due_time: '16:00', repeat_rule: 'Every Day', reminder_time: '16:00', completed: 0, sort_order: 10 },
      { id: 12, title: '💧 喝水+🧍站立', content: '喝几口水，站起来走动一下', priority: 2, due_time: '17:00', repeat_rule: 'Every Day', reminder_time: '17:00', completed: 0, sort_order: 11 },
      { id: 13, title: '🥗 晚餐', content: '先吃菜和肉，主食只吃一半，七八分饱', priority: 2, due_time: '18:30', repeat_rule: 'Every Day', reminder_time: '18:30', completed: 0, sort_order: 12 },
      { id: 14, title: '💧 喝水+🧍站立', content: '加班久了，起来喝几口，站一会儿', priority: 1, due_time: '21:00', repeat_rule: 'Every Day', reminder_time: '21:00', completed: 0, sort_order: 13 },
      { id: 15, title: '💧 喝水+🧍站立', content: '喝几口水，站起来活动一下', priority: 1, due_time: '23:00', repeat_rule: 'Every Day', reminder_time: '23:00', completed: 0, sort_order: 14 },
      { id: 16, title: '🧶 钩织时间', content: '钩几针，听播客放松心情', priority: 1, due_time: '00:00', repeat_rule: 'Every Day', reminder_time: '00:00', completed: 0, sort_order: 15 },
      { id: 17, title: '🧘 睡前拉伸3分钟', content: '靠墙站立1分钟+猫式5次+转头各3次', priority: 2, due_time: '00:30', repeat_rule: 'Every Day', reminder_time: '00:30', completed: 0, sort_order: 16 },
      { id: 18, title: '💤 睡觉', content: '晚安😴', priority: 2, due_time: '01:00', repeat_rule: 'Every Day', reminder_time: '01:00', completed: 0, sort_order: 17 },
    ]},
